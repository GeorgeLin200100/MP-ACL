...
## Dataset
This project utilizes the *TionyStories* dataset, avaliable on [Huggingface/roneneldan/TinyStories](https://huggingface.co/datasets/roneneldan/TinyStories). For quick training, we use the 19.4MB *TinyStries-valid.txt* instead of 1.92GB *TinyStories-train.txt* as our training material. 
